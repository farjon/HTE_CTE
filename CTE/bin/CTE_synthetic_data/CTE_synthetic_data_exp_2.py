...
def main():
    ...
    datapath_train = os.path.join(GetEnvVar('DatasetsPath'), 'CTE_synthetic data', 'Exp 2', 'train')
    datapath_test = os.path.join(GetEnvVar('DatasetsPath'), 'CTE_synthetic data', 'Exp 2', 'test')
