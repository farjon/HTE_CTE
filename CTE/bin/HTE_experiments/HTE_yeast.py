...
from Sandboxes.Farjon.CTE.utils.datasets import Yeast_dataset
...
from Sandboxes.Farjon.CTE.utils.datasets.create_yeast_dataset import main as create_yeast_dataset
...
def main():
    ...
    args.Fern1 = {'K': 10, 'M': 20, 'num_of_features': D_in}
    args.ST1 = {'Num_of_active_words': 2**args.Fern1['K'], 'D_out': D_out}
